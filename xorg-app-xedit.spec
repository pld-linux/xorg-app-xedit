...
# Source0-md5:	08eca655970ae80774245a9fbd917eed
...
install -Dp %{SOURCE1} $RPM_BUILD_ROOT%{_desktopdir}/xedit.desktop
install -Dp %{SOURCE2} $RPM_BUILD_ROOT%{_pixmapsdir}/xedit.png
